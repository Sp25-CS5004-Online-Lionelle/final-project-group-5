...
public class JFrameView extends JFrame implements IView {
    ...
    private Consumer<Movie> addAction = movie -> {};
    ...
    public JFrameView(List<Movie> movies) {
        ...
        // Right panel (user's added movies)
    ...
    public void viewMovieList(List<Movie> movies) {
        userListPanel.updateMovieList(movies);
    }
    ...
    @Override
    public void setAddAction(Consumer<Movie> addAction) {
